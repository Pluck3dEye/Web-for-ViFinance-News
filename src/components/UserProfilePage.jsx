...
export default function UserProfilePage() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors">
      <div className="min-h-screen bg-gradient-to-br from-lime-50 to-lime-100 dark:from-gray-900 dark:to-gray-800 p-6 font-sans text-gray-800 dark:text-gray-100 transition-colors">
        <div className="flex justify-start items-center mb-6">
          <div className="text-3xl cursor-pointer text-lime-600 hover:text-lime-800 transition">
            <FaArrowLeft />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-12">
          ...
          <div className="w-full lg:w-[280px] bg-white dark:bg-gray-700 rounded-2xl shadow-xl p-6 text-center">
            ...
            <div className="space-y-3">
              <button className="w-full bg-lime-500 text-white py-2 rounded-lg hover:bg-lime-600 transition">Edit Profile</button>
              <button className="w-full bg-lime-500 text-white py-2 rounded-lg hover:bg-lime-600 transition">Settings</button>
            </div>
          </div>
        ...
        <div className="flex gap-4 bg-white dark:bg-gray-700 shadow p-4 rounded-xl mb-8 text-center text-sm font-medium text-gray-600 dark:text-gray-300">
          <div className="cursor-pointer hover:text-lime-600 dark:hover:text-lime-400">Overview</div>
          <div className="cursor-pointer hover:text-lime-600 dark:hover:text-lime-400">Spending</div>
          <div className="cursor-pointer hover:text-lime-600 dark:hover:text-lime-400">Saved</div>
        </div>

        {/* Bubble Icons */}
        <div className="flex justify-between md:justify-around mb-12">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="w-12 h-12 bg-gradient-to-br from-lime-300 to-lime-400 dark:from-lime-500 dark:to-lime-400 rounded-full shadow-md" />
          ))}
        </div>
