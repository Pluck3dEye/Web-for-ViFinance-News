...
function TopNavBar({ onMenuClick, menuButtonRef, visible }) {
    ...
    return (
      <nav
        className={`top-nav-bar fixed top-0 left-0 w-full px-3 sm:px-3 py-5 flex items-center z-50 bg-primary-a10 dark:bg-dark-primary-a10 transition-transform duration-300 ${
      ...
      >
        ...
        <a
          href="/"
          className="text-lg font-bold mx-auto md:mx-5"
        >
          ViFinanceNews
        </a>
